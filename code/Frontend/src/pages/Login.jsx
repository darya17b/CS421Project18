    ...
    <>
      <div className="mb-6">
        <button
          ...
          disabled={!oktaAuth}
          className="w-full inline-flex items-center justify-center rounded-md bg-[#981e32] px-4 py-3 text-white font-medium hover:bg-[#7a1828] transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
        >
          Login with WSU
        </button>
      </div>
